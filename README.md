...
专门为 **U9 275HX + RTX 5060 8GB + 32GB RAM** 配置优化，解决8GB显存跑大模型的痛点。
...
| 🎮 **显存感知** | 实时监控RTX 5060显存，避免OOM崩溃 |
| 💻 **CPU兜底** | 24核U9 275HX大模型CPU推理兜底 |
...
cpu.print_status()  # 💻 CPU: 24核/32线程 | 内存: 20.5/32.0 GB 可用
```
...
针对 **RTX 5060 8GB + 32GB RAM** 的推荐配置：
